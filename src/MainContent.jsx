...
const CHARACTERS_DATA = {
  ...
  others: [
    ...
    { id: 4,  name: 'Jelyn',         image: '/images/Jennib.png',    bio: 'Isang Chinoy na dalagang Caviteña na lumaki sa panahong buhay pa si Heneral Paua at umiikot ang bansa sa tensyon ng digmaan at pagbabago. Sa kabila ng kanyang tahimik na kilos, dala niya ang talas ng isip at tibay ng mga taong sanay mabuhay sa gitna ng kaguluhan.'},
    { id: 5,  name: 'Maria',         image: '/images/maria.png',     bio: 'Kilala bilang “Distanciada” na tindera dahil sa kanyang talino, ganda, at malamig na pakikitungo sa iba. Ngunit sa harap ng taong mahal niya, unti-unting nawawala ang kanyang matigas na anyo at lumalabas ang tunay niyang lambing.' },
    { id: 6,  name: 'Luciano',       image: '/images/lancelot.png',  bio: 'Isang lalaking bihasa sa pagmaniobra ng sistema at paggamit ng batas para sa sariling kapakinabangan. Habang abala ang iba sa paghahanap ng sagot, matagal na niyang alam ang galaw ng laro at kung paano ito dayain.' },
    { id: 7,  name: 'Isa',           image: '/images/isawho.png',    bio: 'Isang dalagang nabubuhay sa alaala at pag-asa habang hinihintay ang pagbabalik ng kasintahan niyang si Jorge na nasa digmaan ng mga Hapones. Sa bawat himig ng musika, pilit niyang pinatatag ang pusong unti-unting nilalamon ng pangungulila.'},
    { id: 8,  name: 'Josepa',        image: '/images/josepa.png',    bio: 'Isang sundalong sunud-sunuran sa utos dahil sa takot na maparusahan o maiwan ng sistema. Kahit napapaligiran ng kapwa sundalo, araw-araw niyang dinadala ang matinding lungkot at pakiramdam ng pagiging nag-iisa.'},
    { id: 9,  name: 'Jerome',        image: '/images/jerom.png',     bio: 'Isang binatang laging may gitara sa balikat at matatamis na salita sa labi. Madaling umibig at mas madaling mang-iwan, ngunit sa likod ng kanyang pagiging playboy ay isang pusong takot masaktan nang totoo.'},
    { id: 10, name: 'Rosa',          image: '/images/rosas.png',     bio: 'Isang babaeng madaling magalit at laging tila may dinadalang bigat sa dibdib. Minsan alam niya kung bakit siya galit, ngunit kadalasan ay siya mismo ang naliligaw sa sarili niyang emosyon.' },
    { id: 11, name: 'Maliya',        image: '/images/aliyahate.png', bio: 'Isang flight attendant na kilala sa pagiging mataray at matalim magsalita. Ngunit sa likod ng kanyang matigas na personalidad ay isang kaibigang handang magbigay ng pera at tumulong kahit siya mismo ang nauubos.'},
    { id: 12, name: 'Nicolo',        image: '/images/Nicholo.png',   bio: 'Isang istriktong gwardya na kilala sa matalas na paghihinala at walang pasensyang makinig sa paliwanag ng iba. Para sa kanya, mas mahalaga ang pagsunod sa batas kaysa sa emosyon ng tao.'},
