...
const CHARACTERS_DATA = {
  main: [
    { id: 1, name: 'Emmanuel', power: 145000, image: '/images/boy.png', bio: 'Ang hari ng diskarte. Kayang mag-adapt sa kahit anong hamon na ibato sa kanya. Madiskurso at palabiro, ginagamit niya ang kanyang talino at tawa para malusutan ang anumang gulo.', skills: ['Battle Fury', 'Tribal Strike', 'Sacred Blade'], traits: ['Leadership', 'Courage', 'Strength'] },
    { id: 2, name: 'Grasya', power: 138000, image: '/images/girl.png', bio: 'Ang babaeng walang kinatatakutan. Dahil sa kanyang "Matalas na Pakiramdam" o situational awareness, palagi siyang nauuna sa panganib. Isang adventurous na kaluluwa na hindi kayang ikulong ng kahit anong pader.', skills: ['Silent Strike', 'Revolution Call', 'Freedom Blade'], traits: ['Strategy', 'Speed', 'Rebellion'] }
  ],
  heroes: [
    { id: 3, name: 'Emilio Aguinaldo', power: 152000, image: '/images/ea.png', bio: 'Unang Pangulo ng Pilipinas na namuno sa rebolusyon laban sa Espanya at nagtatag ng unang pamahalaang rebolusyonaryo.', skills: ['Noli Me Tangere', 'Enlightenment', 'Inspire Nation'], traits: ['Wisdom', 'Intellect', 'Inspiration'] },
    { id: 4, name: 'Jose Rizal', power: 149000, image: '/images/rizal.png', bio: 'Isang pambansang bayani ng Pilipinas na manunulat at doktor na gumising sa damdaming makabayan laban sa kolonyalismong Espanyol.', skills: ['Revolution Roar', 'Katipunan Shield', "Patriot's Rage"], traits: ['Bravery', 'Unity', 'Protection'] },
    { id: 5, name: 'Juan Luna', power: 142000, image: '/images/Luna.png', bio: 'Isang kilalang pintor at rebolusyonaryong Pilipino na tanyag sa kanyang makasaysayang obra na sumasalamin sa diwa ng nasyonalismo.', skills: ['Strategic Vision', 'Political Mastery', 'Mind Over Matter'], traits: ['Intelligence', 'Tactics', 'Resilience'] }
  ],
  others: [
    { id: 6,  name: 'Maliya',        power: 140000, image: '/images/aliyahate.png', bio: 'Ang Flight Attendant na hindi mo malilimutan. Sa kabila ng ingay ng paligid, mas malakas ang kanyang boses at mas matindi ang kanyang pasensya. Laging nakangiti, tila ba walang pagod na kayang pawiin ang kaba ng mga biyahero.', skills: ['Presidential Command', 'Tactical Advance', "Republic's Will"], traits: ['Leadership', 'Command', 'Determination'] },
    { id: 7,  name: 'Josepa',        power: 135000, image: '/images/josepa.png',    bio: 'Ang gwardyang naniniwala sa dangal. Sa mundong puno ng gulo, ang kanyang mahigpit na disiplina at katapatan sa mga kaibigan ang nagsisilbing kalasag niya laban sa korapsyon.', skills: ['Healing Touch', "Mother's Blessing", 'Sanctuary'], traits: ['Compassion', 'Nurture', 'Wisdom'] },
    { id: 8,  name: 'Juan Melo',     power: 135000, image: '/images/melo.png',      bio: 'Ang "Tahimik na Matapang." Hindi siya mahilig sa maraming salita, ngunit sa kanyang mga kamay nakasalalay ang mga mahahalagang mensahe. Siya ang tagahatid ng liham na may dalang bigat ng katotohanan.', skills: ['Strike', 'Defend', 'Inspire'], traits: ['Courage', 'Loyalty', 'Strength'] },
    { id: 9,  name: 'Isa',           power: 135000, image: '/images/isawho.png',    bio: 'Isang larawan ng tapat na paghihintay. Habang ang kanyang kasintahang si Jorge ay nasa gitna ng digmaan, tanging ang musika at pag-asa ang nagbibigay sa kanya ng lakas na mangulila at maniwala sa muling pagkikita.', skills: ['Support', 'Rally', 'Guard'], traits: ['Dedication', 'Wisdom', 'Resolve'] },
    { id: 11, name: 'Jelyn',         power: 135000, image: '/images/Jennib.png',    bio: 'Isang adventurer na may malambot na puso para sa mga hayop. Mas komportable siya sa gubat o sa piling ng mga nilalang na may apat na paa kaysa sa loob ng sibilisasyon.', skills: ['Blade', 'Strike', 'Endure'], traits: ['Strength', 'Courage', 'Determination'] },
    { id: 12, name: 'Eumir',         power: 135000, image: '/images/euriblue.png',  bio: 'Ang matipunong taga-greet sa pinto ng paliparan. Hindi lang siya basta helper; siya ay isang lalaking may paninindigan at prinsipyo na makikita sa bawat pagtango at pagbati niya sa mga dumadaan.', skills: ['Combat', 'Defend', 'Support'], traits: ['Loyalty', 'Bravery', 'Tenacity'] },
    { id: 13, name: 'Manong Jhong',  power: 135000, image: '/images/ced.png',       bio: 'Ang maaasahang bagger ng airport. Mabait at laging handang tumulong sa mga bagahe, ngunit may lihim na pagtingin sa kapatid ni Jelyn na nagbibigay sa kanya ng inspirasyon sa bawat araw na pagtatrabaho.', skills: ['Experience', 'Guide', 'Protect'], traits: ['Wisdom', 'Patience', 'Courage'] },
    { id: 14, name: 'Luciano',       power: 135000, image: '/images/lancelot.png',  bio: 'Ang madilim na bahagi ng batas. Malupit, marahas, at mabilis manghusga, si Luciano ang kinatatakutan ng marami dahil sa kanyang kawalan ng awa sa mga nagkakasala.', skills: ['Charge', 'Strike', 'Honor'], traits: ['Valor', 'Honor', 'Strength'] },
    { id: 15, name: 'Nicholas',      power: 135000, image: '/images/Nicholo.png',   bio: 'Isang sundalong naliligaw sa sistema. Sunud-sunuran sa utos dahil sa takot, ngunit sa loob ay nadaramat ang matinding kalungkutan at isolation. Isang gwardyang nag-iisa kahit may mga kasama.', skills: ['Fight', 'Defend', 'Lead'], traits: ['Determination', 'Courage', 'Leadership'] },
    { id: 16, name: 'Rosa',          power: 135000, image: '/images/rosas.png',     bio: 'Ang kakambal na sumasalamin sa klasikong Pilipina. Mahinhin kung kumilos at laging may ngiti sa mga labi, ngunit sa likod ng kanyang pagiging masiyahin ay ang isang pusong matatag at hindi basta-basta sumusuko.', skills: ['Support', 'Inspire', 'Protect'], traits: ['Compassion', 'Strength', 'Resolve'] },
    { id: 17, name: 'Maria',         power: 135000, image: '/images/maria.png',     bio: 'Ang "Distanciada" na kakambal ni Rosa. Kabaligtaran ng kanyang kapatid, siya ay reserved at may bakas ng dugong Kastila sa kanyang turing. Huwag magkakamali, dahil sa likod ng kanyang distansya ay ang isang babaeng palaban at handang manindigan.', skills: ['Strike', 'Defend', 'Lead'], traits: ['Courage', 'Determination', 'Wisdom'] },
